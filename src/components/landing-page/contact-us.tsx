...
export default function ContactUs() {
  return (
    <div>
      ...
      >
        <h1 className="text-3xl md:text-4xl font-bold text-textPrimary mb-10 md:mb-0">
          Contact Us
        </h1>
        ...
        <div className="text-left pt-10 md:pt-0">
          <Link href="http://mlh.io/code-of-conduct">
            <span className="underline text-base md:text-lg text-textPrimary">
              Code of Conduct
            </span>
          </Link>
        </div>
      ...
      <section
        ...
        className="scroll-mt-16 px-10 md:px-24 py-12 md:py-16 h-full relative w-full text-left"
      >
        <h2 className="text-2xl font-bold text-textPrimary mb-10 uppercase">
          Inclusivity Statement
        </h2>
        <p className="text-base md:text-lg text-textPrimary">
          TechNova&apos;s mission is to create safe, inclusive and empowering
          spaces for women and non-binary individuals to start, grow and thrive
          in the technology industry. We ensure that all members of the
          hackathon are respectful of our participants&apos; gender expression.
          The TechNova team would also like to acknowledge that “female” or
          “women” is not an accurate description for many people and it may make
          some feel unwelcome. We use the term Women+ to specifically and
