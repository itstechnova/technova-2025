...
import AvailabilityGrid from "../mentor/AvailabilityGrid";

interface VolunteerAboutYouFormProps {
  data: any;
...
const volunteerInPersonOptions = ["Yes!", "No", "Maybe"];
const tshirtSizeOptions = ["XS", "S", "M", "L", "XL", "2XL", "3XL"];

function VolunteerAboutYouForm({
  data,
  setData,
  handleChange,
  handleSubmit,
  ...
  const updateData = (newData: any) => {
    setData((prev: any) => {
      ...
      sessionStorage.setItem("volunteerAboutYouData", JSON.stringify(updated));
      return updated;
    });
  };
    ...
    <div className="p-10 md:p-24 flex flex-col h-full bg-navPrimary relative">
      ...
      <form className="form z-10" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-24 text-textPrimary">
          ...
          <div className="flex flex-col gap-2">
            <span className="font-bold text-base">
              Are you able to volunteer in person in Waterloo for the duration
              of the hackathon (Sep. 26-28)?*
            </span>
            ...
            <div className="flex flex-col gap-2 mt-2">
              {volunteerInPersonOptions.map((option) => (
                <CheckOff
                  key={option}
                  label={option}
          ...
          <div className="flex flex-col gap-2">
            ...
            <span className="text-base font-semibold">
              ...
              <span className="font-normal">
                {" "}
                The supply for sizes vary, in the event there are no XS,
                volunteers will be sent a S.
              </span>
            </span>
            <Image
...
export default VolunteerAboutYouForm;
